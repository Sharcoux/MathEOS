...
//                "<p style='text-align:left;color:"+couleurExercice+";font-size:"+fontSizeExo+";'><span class='"+JMathTextPane.Bomehc_COMPONENT+" "+JLabelText.JLABEL_TEXTE+"' id='"+id+"s'><span id='"+id+"' style='text-decoration:underline;color:"+couleurExercice+";font-size:"+fontSizeExo+";font-weight:bold;'>"+Traducteur.traduire("exercise") +" "+nombreDExos+"</span></span></p>"
//                    , 0, 0, Tag.P);
    ...
    private class ActionImporterCours extends ActionComplete {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if(!titleMatching) {//Cas de la création d'un nouveau chapitre à partir du fichier
                DialogueBloquant.CHOICE choix = DialogueBloquant.dialogueBloquant("chapter import warning", DialogueBloquant.MESSAGE_TYPE.WARNING, DialogueBloquant.OPTION.OK_CANCEL, f.getTitre(), ImageManager.getIcone("exercise import"));
