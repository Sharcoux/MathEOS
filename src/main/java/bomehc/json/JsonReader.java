...
//        
//        //Custom Writer
//        addReader(bomehc.graphic.composants.Texte.class, new JsonBomehc.Readers.GraphicTexteReader());
//        addReader(java.awt.Color.class, new JsonBomehc.Readers.ColorReader());
//        addReader(bomehc.sauvegarde.Data.class, new JsonBomehc.Readers.DataReader());
//    }
//
...
//            final Map<String, Field> fields = JsonBomehcWriter.getDeepDeclaredFields(cls, null);
//            jsonObj.target = o;
//
//            while (i.hasNext())
//            {
...
//    }
    ...
    {
        return JsonBomehcWriter.getDeepDeclaredFields(c,null).get(fieldName);
    }
