...
import bomehc.arevoir.inutilise.JsonBomehc;
...
//        notReferences.add(Data.class);
    ...
    public static interface JsonWriter {
         void write(Object o, StringBuilder b, JsonBomehcWriter writer);
    }
    
//    private static class EnregistrableWriter implements JsonWriter {
//        @Override
//        public void write(Object o, StringBuilder b, JsonBomehcWriter writer) {
...
//    }
    private static class GraphiqueTexteWriter implements JsonWriter {
        ...
        public void write(Object o, StringBuilder b, JsonBomehcWriter writer) {
            ...
            b.append(texte.getY());
            b.append(",\"offset\":");
            writer.writeObject(texte.getDeplacement(), bomehc.graphic.composants.Vecteur.class, b);
            b.append(",\"content\":");
    ...
    public static String objectToJson(Object o) {
        JsonBomehcWriter jw = new JsonBomehcWriter();
        jw.references.clear();
        jw.visites.clear();
...
//            final int code = o.hashCode();
            ...
            for(final Field f : map.values()) {
                ...
                try {
                    ...
                    Logger.getLogger(JsonBomehc.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        }
    }
