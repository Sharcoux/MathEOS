...
//        System.out.println("config initialized");
        ...
        if(args.length>0) {
            ...
            if(fichier.endsWith(Adresse.EXTENSION_Bomehc)) {
                Configuration.setProfil(fichier);
            } else if(fichier.endsWith(Adresse.EXTENSION_Bomehc_EXPORT_FILE)) {
                importFile = fichier;
            } else {
                erreurCritique(null, fichier+" n'est pas un fichier bomehc", 1);
            }
        }
