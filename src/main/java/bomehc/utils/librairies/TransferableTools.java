...
public abstract class TransferableTools {
    ...
    public static final DataFlavor bomehcArrayFlavor;
    public static final DataFlavor bomehcFlavor;
    ...
    static {
        bomehcArrayFlavor = getFlavor("application/bomehc;class=\""+DataTexte[].class.getName() + "\"");
        bomehcFlavor = getFlavor("application/bomehc;class="+DataTexte.class.getName());
    ...
    public static boolean isContentAccepted(DataFlavor[] T) {
        ...
        if(L.contains(bomehcFlavor)) {return true;}
    ...
    private static class ImageTransferable implements Transferable {
        ...
        public DataFlavor[] getTransferDataFlavors() {
            DataFlavor[] T = {bomehcFlavor, imageFlavor, htmlFlavor, textFlavor};
            return T;
        }
    ...
    private static class DataTransferable implements Transferable {
        ...
        {
            supportedFlavours.add(bomehcFlavor);
...
//            }
    ...
    private static class DataArrayTransferable implements Transferable {
        ...
        @Override
        public DataFlavor[] getTransferDataFlavors() {
            DataFlavor[] T = {bomehcArrayFlavor, bomehcFlavor, htmlFlavor, textFlavor};
            return T;
        }
        ...
        @Override
        public Object getTransferData(DataFlavor flavor) throws UnsupportedFlavorException, IOException {
            if(flavor.equals(bomehcArrayFlavor)) {
                return donnees;
            } else {
