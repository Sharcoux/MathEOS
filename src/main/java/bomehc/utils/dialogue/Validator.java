...
public interface Validator {
    ...
    /**
     * Vérifie que la validation a réussie
     * @param event le DialogueEvent qui sera envoyé si la validation réussie
     * @return true si la validation réussi, false sinon
     */
    public boolean validate(DialogueEvent event);

    /**
     * Effectue une action si la validation échoue, et permet d'ignorer l'envoie du DialogueEvent en renvoyant true
     * @return true si la validation a échouée définitivement et le dialogue ne doit pas fermer
     */
