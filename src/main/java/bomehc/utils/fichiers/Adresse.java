 ...
 * the covered work.
 */
package bomehc.utils.fichiers;


import bomehc.json.JsonBomehcReader;
import bomehc.json.JsonBomehcWriter;
import bomehc.json.JsonReader;
...
public class Adresse extends File {
    ...
    public static final String EXTENSION_Bomehc_EXPORT_FILE = "mef";
...
//        m = new Jackson();
    ...
    public static class BomehcFileFilter extends FileFilter {

        @Override
        public boolean accept(File f) {
            return f.getPath().endsWith(EXTENSION_Bomehc) || f.isDirectory();
        }

        @Override
        public String getDescription() {
            return Traducteur.traduire("bomehc file");
        }
    }
    ...
    public static class SingleFileFilter extends FileFilter {
        ...
        @Override
        public boolean accept(File f) {
            return f.getPath().endsWith(EXTENSION_Bomehc_EXPORT_FILE) || f.isDirectory();
        }

        @Override
        public String getDescription() {
            return Traducteur.traduire("bomehc export file");
        }
    }
        ...
        public Object chargement(File file) {
            ...
            if (file.exists()) {
                try {
                    ...
                    o = JsonBomehcReader.jsonToJava(readStream);
...
//                fw.write(JsonBomehcWriter.objectToJson(o));
                writtenStream = new FileOutputStream(file);
                writtenStream.write(JsonBomehcWriter.objectToJson(o).getBytes(Charset.forName("UTF-8")));
