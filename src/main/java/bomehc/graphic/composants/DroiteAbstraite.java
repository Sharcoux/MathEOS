 ...
 */
public abstract class DroiteAbstraite extends Ligne implements Serializable {
    private static final long serialVersionUID = 1L;

    public DroiteAbstraite() {}

    public double b() {
        Point origine = getOrigine();
        return origine.y()-a()*origine.x();
    }

    public double a() {
        Vecteur vecteur = vecteur();
        //if(vecteur().x()<Repere.ZERO_ABSOLU) { return 0; }//discutable
