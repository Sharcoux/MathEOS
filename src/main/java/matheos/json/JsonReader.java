 ...
 */
//Ajout des betterReader permettant d'accéder à la fonction assignField
...
//        
//        //Custom Writer
//        addReader(matheos.graphic.composants.Texte.class, new JsonMathEOS.Readers.GraphicTexteReader());
//        addReader(java.awt.Color.class, new JsonMathEOS.Readers.ColorReader());
//        addReader(matheos.sauvegarde.Data.class, new JsonMathEOS.Readers.DataReader());
//    }
//
//    public interface JsonClassReader
//    {
//        Object read(Object jOb, LinkedList<JsonObject> stack) throws IOException;
//    }
//    public static abstract class JsonBetterReader implements JsonClassReader
//    {
//        protected BetterReader reader;
//        Object read(Object jOb, LinkedList<JsonObject> stack, BetterReader jsonR) throws IOException {
//            reader = jsonR;
//            Object o = read(jOb, stack);
//            if(jOb instanceof JsonObject) {((JsonObject)jOb).target = o;}
//            return o;
//        }
//        protected void assignFields(LinkedList<JsonObject> stack, JsonObject jsonObj, Object o) throws IOException {
//            reader.assignFields(stack, jsonObj, o);
//        }
//    }
//    
//    protected class BetterReader implements JsonClassReader {
//        private JsonBetterReader reader;
//        private BetterReader(JsonBetterReader reader) {this.reader = reader;}
//        public void assignFields(LinkedList<JsonObject> stack, JsonObject jsonObj, Object o) throws IOException {
//            final Iterator<Map.Entry<String, Object>> i = jsonObj.entrySet().iterator();
//            final Class cls = o.getClass();
//            final Map<String, Field> fields = JsonMathEOSWriter.getDeepDeclaredFields(cls, null);
//            jsonObj.target = o;
//
//            while (i.hasNext())
//            {
...
//                if (field != null)
//                {
//                    JsonReader.this.assignField(stack, jsonObj, field, rhs);
//                }
//            }
...
//
//        @Override
//        public Object read(Object jOb, LinkedList<JsonObject> stack) throws IOException {
//            return reader.read(jOb, stack, this);
//        }
//    }
//
...
//    {
//        JsonClassReader newReader = reader;
//        if(reader instanceof JsonBetterReader) {
//            newReader = new BetterReader((JsonBetterReader) reader);
//        }
...
//            if (clz.equals(c))
//            {
//                item[1] = newReader;   // Replace reader
//                return;
//            }
//        }
//        _readers.add(new Object[] {c, newReader});
//    }
//
...
//    protected Object readIfMatching(Object o, Class compType, LinkedList<JsonObject> stack) throws IOException
//    {
//        if (o == null)
//        {
...
//    }
     ...
     */
    public static JsonObject toMaps(String json) {
        try {
    ...
    public static JsonObject toMaps(InputStream stream) {
        try {
            return jsonToMaps(stream);
        } catch (Exception ignored) {
            return null;
        }
    }
     ...
     * @throws java.io.IOException If an I/O error occurs
     */
    public static JsonObject jsonToMaps(String json) throws IOException {
        ByteArrayInputStream ba = new ByteArrayInputStream(json.getBytes("UTF-8"));
        return jsonToMaps(ba);
    }
    public static JsonObject jsonToMaps(InputStream stream) throws IOException {
        JsonObject map;
        try (JsonReader jr = new JsonReader(stream/*, true*/)) {
            map = (JsonObject) jr.readObject();
        } catch(Exception ex) {
...
//        {
            return o;
//        } else {
//            return convertParsedMapsToJava((JsonObject) o);
//        }
//        return graph;
    }
...
//        Object graph = convertMapsToObjects((JsonObject) root);
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private Object convertMapsToObjects(JsonObject root) throws IOException
//    {
...
//        while (!stack.isEmpty())
//        {
//            JsonObject jsonObj = stack.removeFirst();
//
////            if (useMaps)
////            {
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private void traverseArray(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private void traverseCollectionNoObj(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
//        Object[] items = jsonObj.getArray();
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private void traverseCollection(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
//        Object[] items = jsonObj.getArray();
//        if (items == null || items.length == 0)
//        {
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private void traverseMap(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
//        // Convert @keys to a Collection of Java objects.
////        Object[] keys = (Object[]) jsonObj.get("@keys");
////        Object[] items = jsonObj.getArray();
//        Map.Entry[] map = (Map.Entry[]) jsonObj.get("@map");
//
...
//    private void traverseFieldsNoObj(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
//        final Object target = jsonObj.target;
//        final Set<Map.Entry<String, Object>> set = jsonObj.entrySet();
...
//     * @throws IOException
//     */
//    private void traverseFields(LinkedList<JsonObject> stack, JsonObject jsonObj) throws IOException
//    {
//        Object special;
...
//     * @throws IOException for stream errors or parsing errors.
//     */
//    private void assignField(LinkedList<JsonObject> stack, JsonObject jsonObj, Field field, Object rhs) throws IOException
//    {
...
//            {
//                field.set(target, newInstance(fieldType, null));
//            }
...
//    }
    ...
    {
        return JsonMathEOSWriter.getDeepDeclaredFields(c,null).get(fieldName);
    }
